...
export default function Navbar(){
    ...
    return (
        <div className="flex flex-col md:flex-row items-center justify-between w-full md:justify-between ">
            ...
            <div className={`h-[120px] transition-opacity transition-height duration-5000 delay-100 ease-in-out ${isMobileMenuOpen ? ' opacity-100 mb-8' : ' hidden'} md:absolute md:top-[80px] right-0 md:right-[34rem]`}>
